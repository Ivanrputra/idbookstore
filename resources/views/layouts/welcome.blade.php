    ...
    <!-- <div class=""> -->
        @if (Route::has('login'))
            <!-- <div class="links mainPitch-content background-link"> -->
                ...
                <!--@elseif (Auth::guard('authors')->check())-->
                    <!--<a href="{{ url('/author') }}"><strong>Dashboard Autor</strong></a>-->
                <!--    <script>window.location = "{{ url('/author') }}";</script>-->
                <!--@else-->
                 <!--    <a href="{{ url('/author') }}"><strong>Author</strong></a>
