...
<style>
  ...
  <div class="card">
    <div class="card-header">
        <div class="card-header-title">Chat with Admin</div>
    </div>
    <div class="card-content" style="background-color:khaki">
        @foreach ($chat as $b)
    ...
    <footer class="card-footer">
            {!! Form::open(['url' => 'author/postReply', 'enctype'=>"multipart/form-data", 'class'=>"column is-12 card-footer-item"]) !!}
